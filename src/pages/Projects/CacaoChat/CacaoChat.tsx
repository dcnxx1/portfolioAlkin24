...
export default function CacaoChat() {
  return (
    <DocumentTitle title="Alkin Sali - CacaoChat">
      <Container
        props={{
          style: {
          ...
          <OverviewContainer>
            <ContentContainer>
              ...
              <DescriptionText style={{ paddingBottom: 20 }}>
                ...
                kan chatten. Voer je gebruikersnaam in en de naam van de kamer
                en chat met mensen over de hele wereld!.
              </DescriptionText>
            </ContentContainer>
          </OverviewContainer>
          <TechincalOverviewContainer>
            <ContentContainer>
              ...
              <TagList title="Links">
                <GithubButton
                  href="https://github.com/dcnxx1/Cacaochat-Mobile"
                  title="Mobiel - Code"
                />
                <GithubButton
                  href="https://github.com/dcnxx1/CacaoChat-Browser"
                  title="Browser - Code"
                />
              </TagList>
            </ContentContainer>
