...
export default function QRCode() {
  return (
    <DocumentTitle title="Alkin Sali - QRCode">
      <Container
        props={{
          style: {
        ...
        >
          <Grid.Item style={{ height: "min-content" }}>
            ...
            >
              ...
              <DescriptionText>
                Ontwikkeld met React en ExpressJS, waarmee je moeiteloos
                QR-codes van verschillende formaten kunt creëren. Met een
                gestroomlijnde en intuïtieve interface kunnen gebruikers
                gemakkelijk door de website navigeren en in slechts enkele
                stappen hun gewenste QR-code genereren
              </DescriptionText>
            </ContentContainer>
            <ContentContainer
              style={{
