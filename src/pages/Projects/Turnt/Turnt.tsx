...
export default function Turnt() {
  return (
    <DocumentTitle title="Alkin Sali - Turnt">
        ...
        >
          <MobileGrid>
            <InfoContainer>
              ...
              >
                <HeaderText>
                  Turnt - in 30 seconden Jouw nieuwe nummer!
                </HeaderText>
                ...
                <DescriptionText style={{ paddingBottom: 10 }}>
                  ...
                  Native en NestJS, geïnspireerd door de populaire app TikTok.
                </DescriptionText>
                <DescriptionText style={{ paddingBottom: 10 }}>
                  Wat Turnt uniek maakt, is dat gebruikers moeiteloos nieuwe
                  liedjes en artiesten kunnen ontdekken en met één druk op de
                  knop de beste 30 seconden kunnen beluisteren - zorgvuldig
                  geselecteerd door de artiesten zelf.
                </DescriptionText>
                <DescriptionText>
                  Maar dat is niet alles! Gebruikers hebben ook de mogelijkheid
                  om het volledige nummer te beluisteren, met slechts een tik op
                  het scherm.
                </DescriptionText>
              </ContentContainer>
            </InfoContainer>
            ...
            <TechContainer>
              <ContentContainer>
                <DescriptionText>
                  Naadloos geïntegreerd met het iOS-besturingssysteem, stelt
                  Turnt je in staat om moeiteloos door je feed te navigeren.
                  Skip nummers, speel favorieten opnieuw af of spoel vooruit met
                  gemak - allemaal vanaf je Apple-oortjes of Apple Watch.
                </DescriptionText>
              </ContentContainer>
            </TechContainer>
          </MobileGrid>
          <MobileGrid reverse>
            <InfoContainer>
              ...
              >
                ...
                <DescriptionText>
                  Ontdek een wereld van muziek en video's binnen handbereik.
                  Blader door je eigen verzameling van opgeslagen nummers en
                  geüploade liedjes. Wanneer je een nummer selecteert, opent
                  zich een venster naar de bijpassende muziekvideo, rechtstreeks
                  vanuit je bibliotheek.
                </DescriptionText>
              </ContentContainer>
            </InfoContainer>
            <PhoneContainer>
            ...
            <TechContainer>
              <ContentContainer>
                <DescriptionText style={{ paddingBottom: 10 }}>
                  ...
                  formaat omgezet, waardoor je snel en met de beste kwaliteit
                  van je liedjes kunt genieten.
                </DescriptionText>
                <DescriptionText>
                  Voeg liedjes toe aan je afspeellijst en zie ze gelijk terug in
                  je playlist. Deze technologie wordt aangedreven door React
                  Query. Zodat jij alle wijzingen die jij maakt in je playlist
                  gelijk weer kunt terugzien.
                </DescriptionText>
              </ContentContainer>
            </TechContainer>
          </MobileGrid>
          <MobileGrid>
            <InfoContainer>
              <ContentContainer>
                ...
                <DescriptionText>
                  ...
                  uploaden en selecteer de perfecte 30 seconden die je wilt
            ...
            <TechContainer>
              <ContentContainer style={{ paddingBottom: 10 }}>
                ...
                <DescriptionText>
                  De geselecteerde tijd die de artiest kiest wordt als metadata
                  aan de video toegevoegd. Vervolgens wordt de video verzonden
                  naar de S3-bucket, die een Lambda-functie activeert met de
                  metadata. De Lambda-functie start AWS MediaConvert op met de
                  metadata, zodat de 30 seconden clip in m3u8-formaat wordt
                  gecreëerd. Nadat dit proces is voltooid, wordt de video
                  teruggeplaatst in de S3-bucket, zodat de React Native-app deze
                  kan ophalen met CloudFront CDN
                </DescriptionText>
              </ContentContainer>
              <ContentContainer>
                ...
                <TagList title="Links">
                  <GithubButton
                    href="https://github.com/dcnxx1/turnt-api"
                    title="Back-end"
                  />
                  <GithubButton
                    href="https://github.com/dcnxx1/Turnt"
                    title="Front-end"
                  />
                </TagList>
              </ContentContainer>
